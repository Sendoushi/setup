...
sudo apt-get install -y --fix-missing dmenu rxvt-unicode xclip openbox obconf xinit build-essential pkg-config xorg lxappearance thunar firefox libxss1 libappindicator1 libindicator7 sublime-text code polybar apt-transport-https git-gui;
