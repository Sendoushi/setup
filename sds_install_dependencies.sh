...
rm -rf go1* && curl -O https://dl.google.com/go/go1.10.linux-amd64.tar.gz && tar xvf go1.10.linux-amd64.tar.gz && sudo rm -rf /usr/local/go && sudo mv go /usr/local && rm -rf go1.10.linux-amd64.tar.gz;
